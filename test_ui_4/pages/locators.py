...
class DiskPageLocators():
    ...
    #-DISK_UPLOAD = (By.CSS_SELECTOR, 'input.upload-button__attach')
    #+DISK_UPLOAD = (By.CSS_SELECTOR, 'span.upload-button')
    DISK_UPLOAD = (By.CSS_SELECTOR, 'div.upload-button__attach-wrapper')
    ...
    INPUT_UPLOAD = (By.CSS_SELECTOR, 'input[type="file"]')
